...
- [x] 4.1: Create src/routes/import/+page.svelte with glassmorphism-styled drop zone, file picker, in-game date input, import button, progress bar, summary card [LARGE] (depends: 3.4, 3.5)
...
- [x] 4.4: Create managed club settings component [SMALL] (depends: 3.6, 4.2)

---
## Phase 5: Scouting Backend — Percentiles & Scoring (Rust) [PENDING]
- [x] 5.0: Implement seed_archetypes() in db.rs [LARGE] (depends: 1.3)
- [x] 5.1: Implement percentile computation [LARGE] (depends: 1.3)
- [x] 5.2: Implement quality score computation [MEDIUM] (depends: 5.1)
- [x] 5.3: Implement value score computation [MEDIUM] (depends: 5.1)
- [x] 5.4: Implement archetype score pre-computation [LARGE] (depends: 5.0, 5.2, 5.3)
- [x] 5.5: Implement get_archetypes Tauri command [SMALL] (depends: 5.0)
- [x] 5.6: Implement get_scouting_results Tauri command [LARGE] (depends: 3.6, 5.4)
